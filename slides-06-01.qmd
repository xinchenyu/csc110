...
* Midterm 1 Feb 24, Tuesday -- BRING PHOTO ID
  * Time and room: same as regular lecture
  * Module 1 to Module 6
* Review session
  * Time: Feb 23, Monday 5:00 - 6:30pm
  * Room: TBD
* [Study guide](https://xinchenyu.github.io/csc110/practice-01.html)
...
The function should add all numbers from 0 to `n` in a while loop, and then (outside the loop) return the sum
