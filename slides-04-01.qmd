...
It converts user's `age` to integer and calculates (imperfectly) the year a person of `age` was born by subtracting `age` from `2026`. 
...
#| echo: true
#| eval: false
print( calculate_year_born() ) # user enters 61, function returns 1965
```
