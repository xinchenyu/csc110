...
Weekly quizzes will usually be on Tuesday (when there's no other evaluations) in class (pencil and paper format).

Midterm (individual) exams (pencil and paper format):

-   Midterm Exam 1 - `r schedule %>% filter(exam == "Midterm 1" & term == "spring 2026") %>% pull(formatted_date)`
-   Midterm Exam 2 - `r schedule %>% filter(exam == "Midterm 2" & term == "spring 2026") %>% pull(formatted_date)`

The final exam date and time is: `r schedule %>% filter(exam == "Final Exam" & term == "spring 2026") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "spring 2026") %>% pull(time)` in [BIOE 100](https://classrooms.registrar.arizona.edu/43/100).

You must keep this time available. Do not schedule any flights, travel plans, or other conflicts with these exams.

All assignments that are submitted on Gradescope are due at 9pm (Wednesdays for programming problems and short projects, and Fridays for long projects).


# Week 1 (`r schedule %>% filter(week_number == 1 & term == "spring 2026") %>% pull(formatted_start)`)
...
# Week 2 (`r schedule %>% filter(week_number == 2 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 1](lab01.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 1") %>% pull(formatted_date)` at 9pm
...
# Week 3 (`r schedule %>% filter(week_number == 3 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 2](lab02.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 2") %>% pull(formatted_date)` at 9pm
...
# Week 4 (`r schedule %>% filter(week_number == 4 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 3](lab03.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 3") %>% pull(formatted_date)` at 9pm
...
# Week 5 (`r schedule %>% filter(week_number == 5 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 4](lab04.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 4") %>% pull(formatted_date)` at 9pm
...
# Week 6 (`r schedule %>% filter(week_number == 6 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 5](lab05.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 5") %>% pull(formatted_date)` at 9pm
...
# Week 7 (`r schedule %>% filter(week_number == 7 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 6](lab06.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 6") %>% pull(formatted_date)` at 9pm
...
# Week 8 (`r schedule %>% filter(week_number == 8 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 7](lab07.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 7") %>% pull(formatted_date)` at 9pm
...
# Week 9 (`r schedule %>% filter(week_number == 9 & term == "spring 2026") %>% pull(formatted_start)`)
...
# Week 10 (`r schedule %>% filter(week_number == 10 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 8](lab08.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 8") %>% pull(formatted_date)` at 9pm
...
# Week 11 (`r schedule %>% filter(week_number == 11 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 9](lab09.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 9") %>% pull(formatted_date)` at 9pm
...
# Week 12 (`r schedule %>% filter(week_number == 12 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 10](lab10.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 10") %>% pull(formatted_date)` at 9pm
...
# Week 13 (`r schedule %>% filter(week_number == 13 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 11](lab11.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 11") %>% pull(formatted_date)` at 9pm
...
# Week 14 (`r schedule %>% filter(week_number == 14 & term == "spring 2026") %>% pull(formatted_start)`)
...
-   [Short Project 12](lab12.html) -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 12") %>% pull(formatted_date)` at 9pm
...
# Week 15 (`r schedule %>% filter(week_number == 15 & term == "spring 2026") %>% pull(formatted_start)`)
...
# Week 16 (`r schedule %>% filter(week_number == 15 & term == "spring 2026") %>% pull(formatted_start)`)
