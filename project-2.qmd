...
Programming Projects are to be submitted to [gradescope](https://www.gradescope.com/courses/1213866).
...
You may also modify the code within the `serve` function. However, please ensure that its sole argument, `order`, is restricted to one of the following values: `"plain"`, `"blt"`, `"lettuce wrap"`, `"double"`, `"plain add mushroom"`, and `"double add onion"`.
