...
## Submit attendance - part one

Write ERROR when errors are thrown.
...
my_tuple = (3, 4, 1)
my_tuple.append(3) # evaluate

my_dictionary = {3: 4, 1: 2, 5: 4}
my_dictionary[5] = 10
my_dictionary[5] + my_dictionary[1] # evaluate

my_dictionary.append(4: 5) # evaluate
```
...
## Submit attendance - part two

1.  Its name is `count_names` that opens in read mode [a file that contains a name per line](names.txt), with repeated names
...
Go to [Python Tutor](https://pythontutor.com/), visualize the execution, and submit your attendance. 
