...
#| echo: true
#| eval: false
cube_len = int(input("Cube length? ")) # unique
box_w = int(input("Box width? "))  # similar
box_h = int(input("Box height? ")) # similar
box_l = int(input("Box length? ")) # similar

fit_w = box_w // cube_len # similar
fit_h = box_h // cube_len # similar
fit_l = box_l // cube_len # similar

print(str(fit_w) + " Rubik's cubes will fit width-wise.") # similar
print(str(fit_h) + " Rubik's cubes will fit height-wise.") # similar
print(str(fit_l) + " Rubik's cubes will fit length-wise.") # similar

res = fit_w * fit_h * fit_l # unique
print(str(res)+" Rubik's cubes will fit in that container.") # unique
```
...
## Comparing three blocks of code
