...
-   Off-class discussions among students and questions to the instructors/TAs will be conducted via Piazza. 
    ...
    -   [Piazza link](https://piazza.com/arizona/fall2026/csc110002/home)
    -   Access code: wildcats

-   Do **not** direct message (DM) TAs.

-   Do **not** share code solutions except questions on in-class activities. You are free to share error messages, but not code. TAs and instructors can access your submission on gradescope.
