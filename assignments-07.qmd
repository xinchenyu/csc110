...
def main():
  value = sum_all([])
  assert value == 0, "expected return value was 0, but function returned {}".format(value)
  ...
  assert value == 15, "expected return value was 15, but function returned {}".format(value)
...
def main():
  value = concatenate([])
  assert value == "", \
      "expected return value was an empty string, but function returned {}".format(value)

  value = concatenate(["", "", ""])
  assert value == "  ", \
      "expected return value was an \"  \", but function returned {}".format(value)
  
  value = concatenate(["Hi", "there"])
  assert value == "Hi there", \
      "expected return value was an \"Hi There\", but function returned {}".format(value)
