...
Each paragraph mentions one spider. This lyrics includes three types of spiders: `"itsy bitsy"`, `"big hairy"`, and `"teeny tiny"`, but we can add more types. You can define your own functions and call your functions within `verse` function. Note the `verse` function can only take one of the three arguments (e.g., `"big hairy"`).
