...
If you register after the first class meeting you may make up missed assignments within your first week of attendance. Ask questions on [Piazza](https://piazza.com/arizona/fall2025/csc110/home) when you have questions about assignments, quizzes, and exams (has private options). Email me when you have logistics-related questions.
...
Weekly quizzes will be held every Tuesday (unless otherwise noted). There will be a total of 12 quizzes, and your 2 lowest quiz scores will be dropped when calculating your final grade. Make-up quizzes will not be offered.

What counts as advanced code:

Students are only permitted to use content covered in class or assigned readings when completing programming projects. The use of material beyond this scope is considered advanced code and is not allowed.
