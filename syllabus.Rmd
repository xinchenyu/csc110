...
This is a four-unit course, meeting in the lecture room two times a week (TR). The weekly in-person lab sessions are flexible, meaning students have a number of time slots to choose from. To schedule your lab session go to [the weekly lab session spreadsheet](short-projects.html). 
...
Nov 1 is the last day instructors may administratively drop students. Check more important dates [here](https://registrar.arizona.edu/dates-and-deadlines).
...
All online communication will be conducted through my official UA e-mail address (xinchenyu\@arizona.edu), D2L, and Piazza. Ask questions on [Piazza](https://piazza.com/arizona/spring2026/csc110002) when you have questions about assignments, quizzes, and exams (has private options). Email the instructor only when you have logistics-related questions.
...
```{r}
schedule %>% 
  filter(!is.na(holiday) & term == "fall 2026") %>% 
...
Participation is required and an important part of the learning experience in this course. Students are expected to arrive prepared, engage actively in lectures, contribute to discussions and in-class activities, and collaborate respectfully with their peers.

# Class Absence Policies

Regular attendance is expected because lectures include quizzes, active learning activities and collaborative exercises that cannot be fully replicated outside of class. If you must miss class due to illness, a university-approved activity, or other legitimate circumstances, please notify the instructor as soon as possible. Students are responsible for completing any missed work. Absences pre-approved by the University or the Dean of Students will be accommodated in accordance with University policies.
