...
The final exam date, time and room is: `r schedule %>% filter(exam == "Final Exam" & term == "fall 2025") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "fall 2025") %>% pull(time)`
