...
In addition to the lectures, you will attend one weekly in-person lab session (discussion section). This is the discussion section you selected when you enrolled in the course. The available sections are:

-   Section 002A: [Gould-Simpson](https://goo.gl/maps/h8Vyf7RNQiMAScDY6) Room 930, 3:00-3:50pm, Monday
-   Section 002B: [Gould-Simpson](https://goo.gl/maps/h8Vyf7RNQiMAScDY6) Room 930, 2:00-2:50pm, Friday
-   Section 002C: [Gould-Simpson](https://goo.gl/maps/h8Vyf7RNQiMAScDY6) Room 930, 3:00-3:50pm, Friday
...
If you must miss class due to illness, a university-approved activity, or other legitimate circumstance, please notify the instructor in advance whenever possible. In general, missed quizzes cannot be made up. To accommodate occasional absences, the two lowest quiz scores will be dropped automatically. No additional make-up quizzes or extensions will be provided except in cases approved through the Dean of Students or as otherwise required by University policy.
