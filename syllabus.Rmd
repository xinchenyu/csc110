...
The final exam date, time and room is: `r schedule %>% filter(exam == "Final Exam" & term == "spring 2026") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "spring 2026") %>% pull(time)`.
